...
async function draftPost({ note, instructions, history = [] }) {
  return generate({ system: instructions, turns: [...history, { role: "user", text: note }] });
}

module.exports = { generate, draftPost };
